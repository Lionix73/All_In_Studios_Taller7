...
public class GunManagerMulti2 : NetworkBehaviour
{
    ...
    private NetworkVariable<GunType> GunNet = new NetworkVariable<GunType>(GunType.GoldenFeather, NetworkVariableReadPermission.Everyone);
    ...
    public override void OnNetworkSpawn()
    {
        ...
        if (!IsServer && IsClient && CurrentSecondGunTypeNet.Value == GunType.GoldenFeather)
        {
            DespawnRpc();
            SetUpGunRpc(Gun);
