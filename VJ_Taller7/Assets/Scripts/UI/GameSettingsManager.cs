...
public class GameSettingsManager : MonoBehaviour
{
    ...
    [SerializeField] private InputActionReference lookAction; // Asigna el Input Action "Look" aqu�
    ...
    {
        // Configura el slider (si est� asignado)
    ...
    public void UpdateSensitivity(float newValue)
    {
        ...
        // Si hay una c�mara activa, actualiza su sensibilidad
